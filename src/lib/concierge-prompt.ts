...
export function assembleConciergePrompt(provider: "anthropic" | "openai" | "none"): string {
  ...
  return [
    ...
    `- Most places are invitation-based; the application window is currently closed. If someone has already applied, their application still stands and the committee will be in touch.`,
